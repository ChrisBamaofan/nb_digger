...
CREATE STABLE IF NOT EXISTS cash_flow_statement_yoy_tushare (
    ts TIMESTAMP,
    ts_code VARCHAR(50),                                      
    ann_date VARCHAR(50),                                     
    end_date VARCHAR(50),                                     
    ...
    -- 净利润和财务费用同比变化
    net_profit_abs_yoy DOUBLE,
    net_profit_pct_yoy DOUBLE,
    finan_exp_abs_yoy DOUBLE,
    finan_exp_pct_yoy DOUBLE,
    
    -- 经营活动现金流入同比变化
    c_fr_sale_sg_abs_yoy DOUBLE,
    c_fr_sale_sg_pct_yoy DOUBLE,
    recp_tax_rends_abs_yoy DOUBLE,
    recp_tax_rends_pct_yoy DOUBLE,
    n_depos_incr_fi_abs_yoy DOUBLE,
    n_depos_incr_fi_pct_yoy DOUBLE,
    n_incr_loans_cb_abs_yoy DOUBLE,
    n_incr_loans_cb_pct_yoy DOUBLE,
    n_inc_borr_oth_fi_abs_yoy DOUBLE,
    n_inc_borr_oth_fi_pct_yoy DOUBLE,
    prem_fr_orig_contr_abs_yoy DOUBLE,
    prem_fr_orig_contr_pct_yoy DOUBLE,
    n_incr_insured_dep_abs_yoy DOUBLE,
    n_incr_insured_dep_pct_yoy DOUBLE,
    n_reinsur_prem_abs_yoy DOUBLE,
    n_reinsur_prem_pct_yoy DOUBLE,
    n_incr_disp_tfa_abs_yoy DOUBLE,
    n_incr_disp_tfa_pct_yoy DOUBLE,
    ifc_cash_incr_abs_yoy DOUBLE,
    ifc_cash_incr_pct_yoy DOUBLE,
    n_incr_disp_faas_abs_yoy DOUBLE,
    n_incr_disp_faas_pct_yoy DOUBLE,
    n_incr_loans_oth_bank_abs_yoy DOUBLE,
    n_incr_loans_oth_bank_pct_yoy DOUBLE,
    n_cap_incr_repur_abs_yoy DOUBLE,
    n_cap_incr_repur_pct_yoy DOUBLE,
    c_fr_oth_operate_a_abs_yoy DOUBLE,
    c_fr_oth_operate_a_pct_yoy DOUBLE,
    c_inf_fr_operate_a_abs_yoy DOUBLE,
    c_inf_fr_operate_a_pct_yoy DOUBLE,
    
    -- 经营活动现金流出同比变化
    c_paid_goods_s_abs_yoy DOUBLE,
    c_paid_goods_s_pct_yoy DOUBLE,
    c_paid_to_for_empl_abs_yoy DOUBLE,
    c_paid_to_for_empl_pct_yoy DOUBLE,
    c_paid_for_taxes_abs_yoy DOUBLE,
    c_paid_for_taxes_pct_yoy DOUBLE,
    n_incr_clt_loan_adv_abs_yoy DOUBLE,
    n_incr_clt_loan_adv_pct_yoy DOUBLE,
    n_incr_dep_cbob_abs_yoy DOUBLE,
    n_incr_dep_cbob_pct_yoy DOUBLE,
    c_pay_claims_orig_inco_abs_yoy DOUBLE,
    c_pay_claims_orig_inco_pct_yoy DOUBLE,
    pay_handling_chrg_abs_yoy DOUBLE,
    pay_handling_chrg_pct_yoy DOUBLE,
    pay_comm_insur_plcy_abs_yoy DOUBLE,
    pay_comm_insur_plcy_pct_yoy DOUBLE,
    oth_cash_pay_oper_act_abs_yoy DOUBLE,
    oth_cash_pay_oper_act_pct_yoy DOUBLE,
    st_cash_out_act_abs_yoy DOUBLE,
    st_cash_out_act_pct_yoy DOUBLE,
    n_cashflow_act_abs_yoy DOUBLE,
    n_cashflow_act_pct_yoy DOUBLE,
    
    -- 投资活动现金流入同比变化
    oth_recp_ral_inv_act_abs_yoy DOUBLE,
    oth_recp_ral_inv_act_pct_yoy DOUBLE,
    c_disp_withdrwl_invest_abs_yoy DOUBLE,
    c_disp_withdrwl_invest_pct_yoy DOUBLE,
    c_recp_return_invest_abs_yoy DOUBLE,
    c_recp_return_invest_pct_yoy DOUBLE,
    n_recp_disp_fiolta_abs_yoy DOUBLE,
    n_recp_disp_fiolta_pct_yoy DOUBLE,
    n_recp_disp_sobu_abs_yoy DOUBLE,
    n_recp_disp_sobu_pct_yoy DOUBLE,
    stot_inflows_inv_act_abs_yoy DOUBLE,
    stot_inflows_inv_act_pct_yoy DOUBLE,
    
    -- 投资活动现金流出同比变化
    c_pay_acq_const_fiolta_abs_yoy DOUBLE,
    c_pay_acq_const_fiolta_pct_yoy DOUBLE,
    c_paid_invest_abs_yoy DOUBLE,
    c_paid_invest_pct_yoy DOUBLE,
    n_disp_subs_oth_biz_abs_yoy DOUBLE,
    n_disp_subs_oth_biz_pct_yoy DOUBLE,
    oth_pay_ral_inv_act_abs_yoy DOUBLE,
    oth_pay_ral_inv_act_pct_yoy DOUBLE,
    n_incr_pledge_loan_abs_yoy DOUBLE,
    n_incr_pledge_loan_pct_yoy DOUBLE,
    stot_out_inv_act_abs_yoy DOUBLE,
    stot_out_inv_act_pct_yoy DOUBLE,
    n_cashflow_inv_act_abs_yoy DOUBLE,
    n_cashflow_inv_act_pct_yoy DOUBLE,
    
    -- 筹资活动现金流入同比变化
    c_recp_borrow_abs_yoy DOUBLE,
    c_recp_borrow_pct_yoy DOUBLE,
    proc_issue_bonds_abs_yoy DOUBLE,
    proc_issue_bonds_pct_yoy DOUBLE,
    oth_cash_recp_ral_fnc_act_abs_yoy DOUBLE,
    oth_cash_recp_ral_fnc_act_pct_yoy DOUBLE,
    stot_cash_in_fnc_act_abs_yoy DOUBLE,
    stot_cash_in_fnc_act_pct_yoy DOUBLE,
    free_cashflow_abs_yoy DOUBLE,
    free_cashflow_pct_yoy DOUBLE,
    
    -- 筹资活动现金流出同比变化
    c_prepay_amt_borr_abs_yoy DOUBLE,
    c_prepay_amt_borr_pct_yoy DOUBLE,
    c_pay_dist_dpcp_int_exp_abs_yoy DOUBLE,
    c_pay_dist_dpcp_int_exp_pct_yoy DOUBLE,
    incl_dvd_profit_paid_sc_ms_abs_yoy DOUBLE,
    incl_dvd_profit_paid_sc_ms_pct_yoy DOUBLE,
    oth_cashpay_ral_fnc_act_abs_yoy DOUBLE,
    oth_cashpay_ral_fnc_act_pct_yoy DOUBLE,
    stot_cashout_fnc_act_abs_yoy DOUBLE,
    stot_cashout_fnc_act_pct_yoy DOUBLE,
    n_cash_flows_fnc_act_abs_yoy DOUBLE,
    n_cash_flows_fnc_act_pct_yoy DOUBLE,
    
    -- 汇率变动和现金净增加同比变化
    eff_fx_flu_cash_abs_yoy DOUBLE,
    eff_fx_flu_cash_pct_yoy DOUBLE,
    n_incr_cash_cash_equ_abs_yoy DOUBLE,
    n_incr_cash_cash_equ_pct_yoy DOUBLE,
    c_cash_equ_beg_period_abs_yoy DOUBLE,
    c_cash_equ_beg_period_pct_yoy DOUBLE,
    c_cash_equ_end_period_abs_yoy DOUBLE,
    c_cash_equ_end_period_pct_yoy DOUBLE,
    
    -- 其他筹资活动同比变化
    c_recp_cap_contrib_abs_yoy DOUBLE,
    c_recp_cap_contrib_pct_yoy DOUBLE,
    incl_cash_rec_saims_abs_yoy DOUBLE,
    incl_cash_rec_saims_pct_yoy DOUBLE,
    
    -- 间接法调整项目同比变化
    uncon_invest_loss_abs_yoy DOUBLE,
    uncon_invest_loss_pct_yoy DOUBLE,
    prov_depr_assets_abs_yoy DOUBLE,
    prov_depr_assets_pct_yoy DOUBLE,
    depr_fa_coga_dpba_abs_yoy DOUBLE,
    depr_fa_coga_dpba_pct_yoy DOUBLE,
    amort_intang_assets_abs_yoy DOUBLE,
    amort_intang_assets_pct_yoy DOUBLE,
    lt_amort_deferred_exp_abs_yoy DOUBLE,
    lt_amort_deferred_exp_pct_yoy DOUBLE,
    decr_deferred_exp_abs_yoy DOUBLE,
    decr_deferred_exp_pct_yoy DOUBLE,
    incr_acc_exp_abs_yoy DOUBLE,
    incr_acc_exp_pct_yoy DOUBLE,
    loss_disp_fiolta_abs_yoy DOUBLE,
    loss_disp_fiolta_pct_yoy DOUBLE,
    loss_scr_fa_abs_yoy DOUBLE,
    loss_scr_fa_pct_yoy DOUBLE,
    loss_fv_chg_abs_yoy DOUBLE,
    loss_fv_chg_pct_yoy DOUBLE,
    invest_loss_abs_yoy DOUBLE,
    invest_loss_pct_yoy DOUBLE,
    decr_def_inc_tax_assets_abs_yoy DOUBLE,
    decr_def_inc_tax_assets_pct_yoy DOUBLE,
    incr_def_inc_tax_liab_abs_yoy DOUBLE,
    incr_def_inc_tax_liab_pct_yoy DOUBLE,
    decr_inventories_abs_yoy DOUBLE,
    decr_inventories_pct_yoy DOUBLE,
    decr_oper_payable_abs_yoy DOUBLE,
    decr_oper_payable_pct_yoy DOUBLE,
    incr_oper_payable_abs_yoy DOUBLE,
    incr_oper_payable_pct_yoy DOUBLE,
    others_abs_yoy DOUBLE,
    others_pct_yoy DOUBLE,
    im_net_cashflow_oper_act_abs_yoy DOUBLE,
    im_net_cashflow_oper_act_pct_yoy DOUBLE,
    
    -- 特殊项目同比变化
    conv_debt_into_cap_abs_yoy DOUBLE,
    conv_debt_into_cap_pct_yoy DOUBLE,
    conv_copbonds_due_within_1y_abs_yoy DOUBLE,
    conv_copbonds_due_within_1y_pct_yoy DOUBLE,
    fa_fnc_leases_abs_yoy DOUBLE,
    fa_fnc_leases_pct_yoy DOUBLE,
    im_n_incr_cash_equ_abs_yoy DOUBLE,
    im_n_incr_cash_equ_pct_yoy DOUBLE,
    net_dism_capital_add_abs_yoy DOUBLE,
    net_dism_capital_add_pct_yoy DOUBLE,
    net_cash_rece_sec_abs_yoy DOUBLE,
    net_cash_rece_sec_pct_yoy DOUBLE,
    
    -- 新增字段同比变化
    credit_impa_loss_abs_yoy DOUBLE,
    credit_impa_loss_pct_yoy DOUBLE,
    use_right_asset_dep_abs_yoy DOUBLE,
    use_right_asset_dep_pct_yoy DOUBLE,
    oth_loss_asset_abs_yoy DOUBLE,
    oth_loss_asset_pct_yoy DOUBLE,
    end_bal_cash_abs_yoy DOUBLE,
    end_bal_cash_pct_yoy DOUBLE,
    beg_bal_cash_abs_yoy DOUBLE,
    beg_bal_cash_pct_yoy DOUBLE,
    end_bal_cash_equ_abs_yoy DOUBLE,
    end_bal_cash_equ_pct_yoy DOUBLE,
    beg_bal_cash_equ_abs_yoy DOUBLE,
    beg_bal_cash_equ_pct_yoy DOUBLE,
