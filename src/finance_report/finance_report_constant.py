...
class FinanceReportConstant:
    def __init__(self):
        self.is_numeric_fields = ['basic_eps','diluted_eps','total_revenue','revenue','int_income','prem_earned',
        ...
        'withdra_legal_surplus','withdra_legal_pubfund','withdra_biz_devfund','withdra_rese_fund',
        ...
        self.is_fields_all = [
            ...
            'end_net_profit', 'update_flag', 'created_time', 'updated_time'
        ]
        self.bs_numeric_fields = []
        self.is_fields = []
        self.cfs_numeric_fields = []
        self.cfs_fields = []
